...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   TString fname = "/home/dell/FlatTree/Signal_Tree2.root";
   TString fname2 = "/home/dell/FlatTree/Background_Tree2.root";
   ...
   TTree *signalTree     = (TTree*)input->Get("ST");
   TTree *background     = (TTree*)input2->Get("BT");
   ...
   for(int i=0;i<30;i++){
    for(int j=0;j<6;j++){
      ...
      dataloader->AddVariable(ch, 'F' );
    }
   }
   // dataloader->AddVariable( "Bin1515", 'F' );
   //dataloader->AddVariable( "Bin1415", 'F' );
   ...
   // dataloader->AddSpectator( "Bin1414",  "Spectator 1", "units", 'F' );
   ...
   dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=70:nTrain_Background=70:SplitMode=Random:NormMode=NumEvents:!V" );
